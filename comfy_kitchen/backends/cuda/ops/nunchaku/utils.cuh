...
__device__ __forceinline__ typename packed_as<f16_t, 2>::type f162f162(f16_t x);

template<>
__device__ __forceinline__ typename packed_as<half, 2>::type f162f162<half>(half x) {
    return __half2half2(x);
}

#ifdef ENABLE_BF16
template<>
__device__ __forceinline__ typename packed_as<__nv_bfloat16, 2>::type f162f162<__nv_bfloat16>(__nv_bfloat16 x) {
